  ...
  return (
    <div className="container py-4">
      ...
      {!loading && !error && (
        ...
        >
          <table className="table align-middle mb-0" style={{ width: "100%" }}>
            <colgroup>
              <col style={{ width: "5%" }} />
              <col style={{ width: "30%" }} />
              <col style={{ width: "40%" }} />
              ...
              {filteredUsers.map((u) => (
                <tr key={u.id} style={{ backgroundColor: "#cceffc" }}>
                  ...
                  <td style={{ textAlign: "center", whiteSpace: "nowrap" }}>
                    <div className="d-none d-sm-flex justify-content-center gap-1">
                      <button
                    ...
                    <div className="d-flex d-sm-none justify-content-center gap-2">
                      <button
                      ...
                      <button
                        ...
                        onClick={() => openModal("orders", u)}
                      >
                        <i className="fa fa-list fs-5" style={{ color: "#004466" }}></i>
                      </button>
                    </div>
                  </td>
                </tr>
